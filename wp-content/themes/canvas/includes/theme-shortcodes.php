...
function woo_shortcode_footer_woothemes_link ( $atts ) {
	...
	$output = sprintf( '%s<a href="%s" title="%s">%s</a>%s', $atts['before'], esc_url( $woo_link ), 'WooThemes', '<img src="' . esc_url( get_template_directory_uri() . '/images/woothemes.png' ) . '" width="74" height="19" alt="WooThemes" />', $atts['after'] );
